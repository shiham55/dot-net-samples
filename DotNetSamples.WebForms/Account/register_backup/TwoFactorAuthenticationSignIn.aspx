<%@ Page Title="Two-Factor Authentication" Language="C#"  MasterPageFile="~/common/UI/ShopMaster/Site.Master"  AutoEventWireup="true" CodeBehind="TwoFactorAuthenticationSignIn.aspx.cs" Inherits="Shop.Account.TwoFactorAuthenticationSignIn" %>
