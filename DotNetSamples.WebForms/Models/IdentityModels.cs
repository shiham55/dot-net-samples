...
namespace DotNetSamples.WebForms.Models
{
...
//{
    public static class IdentityHelper
    {
        ...
        {
            return Config.ApplicationUrl + "/Account/ResetPassword?" + CodeKey + "=" + HttpUtility.UrlEncode(code);
        }

        public static string GetUserConfirmationRedirectUrl(string code, string userId)
        {
            return Config.ApplicationUrl + "/Account/Confirm?" + CodeKey + "=" + HttpUtility.UrlEncode(code) + "&" + UserIdKey + "=" + HttpUtility.UrlEncode(userId);
        }
